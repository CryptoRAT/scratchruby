...
It was the worst of times.
    ...
    # Are we counting the occurrences of \n here?
...
EOS
    ...
    # assert_equal __, long_string.lines.count
    # Note that EOS does not represent a newline.
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #
    # Because its faster.  The shovel operator appends to the end of the current, whereas += creates a new
    # String and sets it value to the first part + second part.
  end
  ...
  def test_single_quotes_sometimes_interpret_escape_characters
    string = '\\\''
    # assert_equal __, string.size
    # The two characters are \ and '.  Why is this? We escaped them, so they are recognized?
    assert_equal 2, string.size
    # assert_equal __, string
    assert_equal "\\'", string
  end
  ...
  def test_any_ruby_expression_may_be_interpolated
    ...
    sqrt_of_five = Math.sqrt(5)
      # assert_equal __, string
      assert_equal "The square root of 5 is " + sqrt_of_five.to_s, string
  end

  def test_you_can_get_a_substring_from_a_string
    string = "Bacon, lettuce and tomato"
    # Note that is 0 indexed.
    # Note that the second operand is the number of characters to get
    # assert_equal __, string[7,3]
    assert_equal 'let', string[7,3]
    # assert_equal __, string[7..9]
    # Trick here is that we are asking for a range.
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised?
    # No.  Should I be?  What am I missing?
  end
