...
class AboutObjects < Neo::Koan
  ...
  def test_small_integers_have_fixed_ids
    ...
    # assert_equal __, 3.object_id
    assert_equal ((2 * 3) +1), 3.object_id
    # assert_equal __, 4.object_id
    assert_equal ((2 * 4) +1), 4.object_id
    # assert_equal __, 5.object_id
    assert_equal ((2 * 5) +1), 5.object_id
    # assert_equal __, 6.object_id
    assert_equal ((2 * 6) +1), 6.object_id
    # assert_equal __, 7.object_id
    assert_equal ((2 * 7) +1), 7.object_id
