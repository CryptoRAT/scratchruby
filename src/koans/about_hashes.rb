...
class AboutHashes < Neo::Koan
  ...
  def test_accessing_hashes_with_fetch
    ...
    #
    # It seems this question is really: nil vs KeyError.  Using fetch means the system will fail over if the key
    # doesn't exist.  This is mostly what you want.  IMHO.
  end
  ...
  def test_changing_hashes
    ...
    #
    # For me, this separates defining the expected value from actually doing the compare.  Ultimately, this makes it
    # easier to reuse the pattern.
  end
  ...
  def test_default_value_with_block
    ...
    # Append objects to the end of the hash
    hash[:one] << "uno"
    hash[:two] << "dos"
    # Note that for merges, it isn't a default, you are setting the value
    hash = hash.merge({ :four => ["quattro"] })
    ...
    # my own to test merges
    assert_equal ["quattro"], hash.fetch(:four)
  end
end
